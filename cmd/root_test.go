...
func TestReleaseCLIExposesOnlyImplementedScanFlags(t *testing.T) {
	for _, name := range []string{"evasion", "list", "discord-webhook", "follow-redirects", "redirect-depth", "check-vhost", "check-web-deps", "related-hosts", "aggressive", "aggressive-confirm-auto-claim", "aggressive-allowlist"} {
