...
func Primary(analysis *core.HostAnalysis) Context {
	...
	priorities := []string{
		...
		"PLAINTEXT_AUTH_INTERFACE", "HTTP_SENSITIVE_COOKIE_WITHOUT_SECURE", "PLAINTEXT_WEB_CONTENT",
		"HTTPS_DOWNGRADE_REDIRECT", "HTTP_HTTPS_PORT_INCONSISTENT", "HTTP_NO_HTTPS_UPGRADE",
