...
## Catálogo `can-i-take-over-xyz`

Parte das assinaturas CNAME em `pkg/signatures/fingerprints.json` deriva do catálogo
[Can I take over XYZ?](https://github.com/EdOverflow/can-i-take-over-xyz), criado por
...
- acrescenta tipo de verificação, confiança e requisitos de prova;
- inclui assinaturas multivetor mantidas neste repositório;
